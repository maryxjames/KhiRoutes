    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Feedbacks User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.feedbacks_user &&
                      Array.isArray(users.feedbacks_user) &&
                      users.feedbacks_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
