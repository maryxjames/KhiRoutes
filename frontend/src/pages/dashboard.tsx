...
const Dashboard = () => {
  ...
  const [feedbacks, setFeedbacks] = React.useState('Loading...');
  const [notifications, setNotifications] = React.useState('Loading...');
  const [routes, setRoutes] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_FEEDBACKS') && (
          ...
          {hasPermission(currentUser, 'READ_ROUTES') && (
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiMapMarkerPath || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
