...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/routes/routesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureRoutesCols';
...
const TableSampleRoutes = ({
  ...
  useEffect(() => {
    if (routesNotify.showNotification) {
      notify(routesNotify.typeNotification, routesNotify.textNotification);
    }
  }, [routesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/routes/routes-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {routes && Array.isArray(routes) && !showGrid && (
        <ListRoutes
          routes={routes}
          loading={loading}
...
export default TableSampleRoutes;
